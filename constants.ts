...
export const CONTRIBUTORS = [
	{
		...
		url: "https://example.com/ahmed",
	},
	{
		id: "sara",
		name: "Sara Smith",
		avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Sara",
		url: "https://example.com/sara",
	},
	{
		id: "omar",
		name: "Omar Khaleel",
		avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Omar",
		url: "https://example.com/omar",
	},
	{
		id: "huda",
		name: "Huda Ben",
		avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Huda",
		url: "https://example.com/huda",
	},
	{
		id: "karim",
		name: "Karim Zayd",
		avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Karim",
		url: "https://example.com/karim",
	},
];
...
export const MOCK_SCREENSHOTS: Record<string, Screenshot[]> = {
	"wahda-bank": [
		...
		{
			id: "2",
			url: "https://picsum.photos/seed/wahda2/400/800",
			label: "Accounts",
			category: "dashboard",
		},
	],
	"sahara-bank": [
		{
			id: "1",
			url: "https://picsum.photos/seed/sahara1/400/800",
			label: "Welcome",
			category: "onboarding",
		},
		{
			id: "2",
			url: "https://picsum.photos/seed/sahara2/400/800",
			label: "Card Details",
			category: "dashboard",
		},
		{
			id: "3",
			url: "https://picsum.photos/seed/sahara3/400/800",
			label: "Profile",
			category: "settings",
		},
	],
	"north-bank": [
		{
			id: "1",
			url: "https://picsum.photos/seed/north1/400/800",
			label: "Splash Screen",
			category: "onboarding",
		},
		...
		{
			id: "3",
			url: "https://picsum.photos/seed/north3/400/800",
			label: "Home Dashboard",
			category: "dashboard",
		},
		{
			id: "4",
			url: "https://picsum.photos/seed/north4/400/800",
			label: "Transfer",
			category: "transaction",
		},
		{
			id: "5",
			url: "https://picsum.photos/seed/north5/400/800",
			label: "Settings",
			category: "settings",
		},
	],
